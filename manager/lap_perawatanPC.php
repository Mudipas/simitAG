...
$data = array(
	array($no++, $bagianbesar, generatebulan($bulanDB), $tanggal_realisasi, $id, $namapc.'/'.$user, $item1, $item2, $item3, $item4, $item5, $item6, $item7, $treated_by , $approve_by , ''),
