...
<form action="lap_pemakaipc.php"   method="POST" id="input_form" >
<table >
<tr>
<td colspan="3" align="center" class="judul">DAFTAR PEMAKAI PC  PDF</td>
</tr>
 <tr>
 <td>Divisi :</td>
 <td> :</td>
...
<form action="../excel/pemakaipc_excel.php"   method="POST" id="input_form">
<table>
<tr>
<td colspan="3" align="center" class="judul">DAFTAR PEMAKAI PC EXCEL</td>
</tr>
<tr>
 <td>Divisi :</td>
 <td> :</td>
