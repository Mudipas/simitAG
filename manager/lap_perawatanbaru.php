...
$pdf->SetWidths(array(10,20,25,25,60,10,10,10,10,15,15,15,15,15,15,10));
//$pdf->SetWidths(array(10,20,25,25,60,10,10,10,10,15,15,15,15,15,15,10));
...
$pdf->Row(array($no++,$bulanbesar,$tgl_realisasi,$ippc,$namapc.'/'.$user,$osbesar,$appsbesar,'',$cpubesar,$monitorbesar,$printerbesar,'','',$petugas,$a,$keterangan));
}}
$pdf->Output();
?>
