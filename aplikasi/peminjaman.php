...
<?php
$query_rinci_jual="SELECT *,sum(jumlah) as jum  FROM trincipinjam WHERE nopinjam='".$no_faktur."'  group by idbarang";
...
?>
<script language="JavaScript" type="text/javascript" src="suggestpinjam.js"></script>
<style>
.isi_tabelll {
border:1px;
...
document.getElementById('divisiup15').value=(isi3);
 ...
 function permintaan4(isi4){
if(isi4==""){
document.getElementById('telpup').value="";
document.getElementById('telpup2').value="";
document.getElementById('telpup3').value="";
document.getElementById('telpup4').value="";
document.getElementById('telpup5').value="";
document.getElementById('telpup6').value="";
document.getElementById('telpup7').value="";
document.getElementById('telpup8').value="";
document.getElementById('telpup9').value="";
document.getElementById('telpup10').value="";
document.getElementById('telpup11').value="";
document.getElementById('telpup12').value="";
document.getElementById('telpup13').value="";
document.getElementById('telpup14').value="";
document.getElementById('telpup15').value="";}
else{
document.getElementById('telpup').value=(isi4);
document.getElementById('telpup2').value=(isi4);
document.getElementById('telpup3').value=(isi4);
document.getElementById('telpup4').value=(isi4);
document.getElementById('telpup5').value=(isi4);
document.getElementById('telpup6').value=(isi4);
document.getElementById('telpup7').value=(isi4);
document.getElementById('telpup8').value=(isi4);
document.getElementById('telpup9').value=(isi4);
document.getElementById('telpup10').value=(isi4);
document.getElementById('telpup11').value=(isi4);
document.getElementById('telpup12').value=(isi4);
document.getElementById('telpup13').value=(isi4);
document.getElementById('telpup14').value=(isi4);
document.getElementById('telpup15').value=(isi4);
}}
...
if(key==13){
document.location.href="aplikasi/simpanrincipeminjaman.php?kd_barang="+kd_barang+"&no_faktur="+no_faktur;} }
</script>
</head>
...
?>PEMINJAMAN BARANG </h4>


<div style="overflow:scroll;width:600px;height:450px;" id="data_barang">
        <div class="panel-bod">
                            <div class="table-responsiv">
                 					<form action="aplikasi/simpanrincipinjam.php" method="post" >
 ...
 <input  class="form-control"  type="hidden" id="telpup"  name="telp" value="<?php echo $telp; ?>"  >
...
<div  id="layer1" onclick="new sendRequest(this.value)"  class="isi_tabelll" ></div></div></td>
 ...
 <td><input  class="form-contro" type="text"  name="jumlah" value='1' readonly ></td>
...
$jum=$data_rinci['jum'];
  ...
  <tr class="tr_isi">
    ...
    <td><?php echo $jum; ?>&nbsp;</td>
	 ...
	 <td><form action="aplikasi/deleterincipinjam.php" method="post" >
							  <input  class="form-control"  type="hidden" id="namaup<?echo $angka++;?>"  name="nama" value="<?php echo $nama; ?>"   >	  
 <input  class="form-control"  type="hidden" id="bagianup<?echo $angka2++;?>"  name="bagian"  value="<?php echo $id_bagianup; ?>" >	 
 <input  class="form-control"  type="hidden" id="divisiup<?echo $angka3++;?>"  name="divisi" value="<?php echo $divisi; ?>"  >	
 <input  class="form-control"  type="hidden" id="telpup<?echo $angka4++;?>"  name="telp" value="<?php echo $telp; ?>"  >
...
<div id="info_transaksi">
 ...
 <!--   <div id="scanner">Barcode : 
  ...
  -->
      ...
      <form id="form_penjualan" name="form_penjualan" method="post" action="aplikasi/simpanpinjam.php" >
        ...
        <br >
                                            ...
                                            <input  class="form-control" value="<?php echo $datee; ?>" type="hidden" name="tgl1" readonly>
		
		
                                            
                                            <input  class="form-control" value="<?php echo $jam; ?>" type="hidden" name="jam1" readonly >											

		Nama
		
                                            
                                            <input  class="form-control"  type="text" value="<?php echo $nama; ?>" name="nama" onchange="new permintaan(this.value)"  >
 ...
 <option value="TEXTILE">TEXTILE</option>
  <option value="DIV.UMUM">DIV.UMUM</option>
          	...
          	Line Telp / No HP
                                            ...
                                            <input  class="form-control"  type="text" value="<?php echo $telp; ?>" name="telp" onchange="new permintaan4(this.value)" >                           
<br>
       
	    
   <?	$sss = mysql_query("SELECT * FROM trincipinjam where nopinjam='$no_faktur'");
				if(mysql_num_rows($sss) > 0){
						while($datas = mysql_fetch_array($sss)){
							$idbarang=$datas['idbarang'];
							$tt = mysql_query("SELECT * FROM boking where idbarang='$idbarang' and tgl='$datee'");
				if(mysql_num_rows($tt) > 0){
					while($datatt = mysql_fetch_array($tt)){
							$tglboking=$datatt['tgl'];
							$t=substr($tglboking,-2,2);
							$b=substr($tglboking,-5,2);
							$th=substr($tglboking,0,4);
							$tglsek=$t.'-'.$b.'-'.$th;
							$idbarang=$datatt['idbarang'];
							$keperluan=$datatt['keperluan'];
					...
					$namabarang=$databb['namabarang'];}
							$kata="Peringatan !! <br> Mohon Maaf Tidak Bisa Meminjam <br>  ".$namabarang."   <br>  Sudah di Boking <br>    Tgl &nbsp ".$tglsek."<br> ".$keperluan;
							$isi='isi';
							?>
				<font color='red' size='4'><? echo $kata;?>
				</font>
				<?}}?>
...
&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
 <button  name="tombol_selesai" id="button_selesai" class="btn text-muted text-center btn-danger" type="submit">Simpan</button>
				<?}?>
	  </form>
