...
<div style="overflow:scroll;width:600px;height:450px;" id="data_barang">
        <div class="panel-bod">
							...
							<form action="aplikasi/simpanrincireturpengambilan.php" method="post" name="fsimpan" >
...
$jum=$data_rinci['jum'];
  ...
  <tr class="tr_isi">
    ...
    <td><?php echo $jum; ?>&nbsp;</td>
	 ...
	 <td><form action="aplikasi/deleterincireturpengambilan.php" method="post" >
...
-->
      ...
      <form id="form_penjualan" name="form_penjualan" method="post" action="aplikasi/updatereturpengambilan.php" >
