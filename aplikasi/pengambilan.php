...
$dd=mysql_query("select * from trincipengambilan where nofaktur='$no_faktur' and sesi='ADM' ");
...
<div style="overflow:scroll;width:600px;height:450px;" id="data_barang">
        <div class="panel-bod">
							...
							<form action="aplikasi/simpanrincipengambilan.php" method="post" name="fsimpan" >
...
$jum=$data_rinci['jum'];
  ...
  <tr class="tr_isi">
    ...
    <td><?php echo $jum; ?>&nbsp;</td>
	 ...
	 <td><form action="aplikasi/deleterincipengambilan.php" method="post" >
...
-->
      ...
      <form id="form_penjualan" name="form_penjualan" method="post" action="aplikasi/simpanpengambilan.php" >
...
<?}else{?>
  ...
  <div class="col-lg-12">
	...
	<h4>halaman masih digunakan admin</h4>
