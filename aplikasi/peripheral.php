						...
						<table class="table table-striped table-bordered table-hover" id="dataTables-example">
							...
							<tbody>
								...
								<tr class="gradeC">
									...
									<td class="center">
										<button class="btn btn-primary" value='<?php echo $nomor; ?>' data-toggle="modal" data-target="#newReggg" onclick="sendRequest(this.value)">Edit</button>
									</td>
									<td class="center">
					...
					<div class="modal-body">
						<form action="aplikasi/simpanPeripheral.php" method="post" enctype="multipart/form-data" name="postform2">
							<div class="form-group">
								<input class="form-control" type="hidden" name="nomor" value="<?php echo kdauto("peripheral", ""); ?>" readonly>
							</div>
							<div class="form-group">
								ID Perangkat
							...
							<div class="form-group">
								<b>Divisi</b>
								<select class="form-control" name="divisi" required="required" disabled>
									<option value="AMBASSADOR" selected>AMBASSADOR</option>
								</select>
								<input type="hidden" name="divisi" value="AMBASSADOR">
							</div>
