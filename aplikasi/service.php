...
document.getElementById('perangkat').value = string[3];
            ...
            <div class="inner">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <h2>Daftar Antrian Service Komputer </h2>
...
<input name="status" type="hidden" value="PENDING">
	  ...
	  Tanggal Request  &nbsp &nbsp  &nbsp
                        ...
                        <div class="modal fade" id="newReggg" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                       <form action="aplikasi/simpanservicedalam.php" method="post"  enctype="multipart/form-data" name="postform2">
                        ...
                        <div class="modal fade" id="newReggggg" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                       <form action="aplikasi/simpanserviceluar.php" method="post"  enctype="multipart/form-data" name="postform2">
