...
<body onload="document.getElementById('kd_barang').focus()">
	...
	<div id="info_transaksi">
      	<form id="form_penjualan"  method="post" action="aplikasi/simpaninputpcV2.php" enctype="multipart/form-data" name="postform2" >
	  	Nomor
	  	<input  readonly class="form-control"  type="text" name="nomoroke" value="<? echo kdauto("pcaktif",""); ?>" >
        Divisi                                    
