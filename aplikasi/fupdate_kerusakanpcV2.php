...
$nomor=$_POST['nomor'];
$lihat=mysql_query("select * from pcaktif2 where nomor='$nomor'");
...
<body onload="document.getElementById('kd_barang').focus()">
	...
	<div id="info_transaksi">
    	<form id="form_penjualan"  method="post" action="aplikasi/updatekerusakanpcV2.php" enctype="multipart/form-data" name="postform2" >
